...
class Main {
	...
	static function main() {
		...
		var outputPath:String = "d:\\development\\as3tohaxe_output";
		...
		//for (t in CustomTypes.getInstance().matches.keys()) {
		//	Lib.println(t + " => " + CustomTypes.getInstance().matches.get(t));
		//}
